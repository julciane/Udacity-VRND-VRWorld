...
public class UdacityFunEffects : MonoBehaviour
{
    ...
    public Text flashLightText = null;
    ...
    {
        bool isFlasLightOn = flashLight.gameObject.activeInHierarchy;
        flashLight.gameObject.SetActive(!isFlasLightOn);
        if (isFlasLightOn)
        {
            flashLightText.text = "Turn flashlight on";
        }
        else
        {
            flashLightText.text = "Turn flashlight off";
        }
    ...
    private IEnumerator AnimateSun(bool isSunUp)
    {
        ...
        if (isSunUp)
        {
            sunText.text = "Turn night";
        }
        else
        {
            sunText.text = "Turn day";
        }
